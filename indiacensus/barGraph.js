...
d3.json("india2011.json", function(error, data){
    ...
    data.forEach(function(d){
        ...
        console.log(d.TotalLiteratePop);
    });
    data.sort(function(a,b){
    return b.TotalLiteratePop- a.TotalLiteratePop;
    });
...
svg_population.selectAll('rect')
    ...
    .attr({
        ...
        'y': function(d){
        return yScale(d.TotalLiteratePop);
        },
        "width": xScale.rangeBand(),
        "height": function(d){
        return height-yScale(d.TotalLiteratePop);
        }
    });
